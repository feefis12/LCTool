...
def findFile():
    root.filename = filedialog.askopenfilename(initialdir="C://Users//Felix//Desktop/",
                                               title="Select Cover",filetypes=(("jpg files", "*.jpg"),("png files" ,"*.png"),))
    pickerC()
...
getPicButton = Button(root, text='Select Folder', padx=50,pady=25, command=findFile)
spot = Canvas(root, width=1920, height=1080)
root.resizable(False, False)
getPicButton.pack()
root.title('Cover Tool')
root.wm_iconbitmap('lakeaffected.ico')
root.geometry('150x150+800+300')
